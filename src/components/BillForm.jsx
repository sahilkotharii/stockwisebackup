    ...
    <form id={type + "-form"} onSubmit={e => { e.preventDefault(); handleSave(); }} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div className="glass" style={{ borderRadius: T.radius, overflow: "visible", padding: 0 }}>
        ...
        <div style={{ overflow: "visible" }}>
          ...
          <div className="hide-mob" style={{ display: "grid", gridTemplateColumns: "2fr 80px 120px 100px 36px", gap: 12, padding: "10px 16px", background: T.isDark ? "rgba(255,255,255,0.02)" : "rgba(0,0,0,0.02)", borderBottom: `1px solid ${T.borderSubtle}` }}>
          ...
          {items.map((item, i) => {
            ...
            return (
              <div key={item.id} className="liquid-trans" style={{ borderBottom: `1px solid ${T.borderSubtle}`, padding: "14px 16px", background: T.surfaceGlass, overflow: "visible" }}>
                ...
                {/* Desktop View */}
                <div className="hide-mob" style={{ display: "grid", gridTemplateColumns: "2fr 80px 120px 100px 36px", gap: 12, alignItems: "start", overflow: "visible" }}>
                  <div style={{ overflow: "visible" }}>

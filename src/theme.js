...
.inp,.sel{width:100%;background:${T.isDark?"rgba(0,0,0,0.25)":"#fff"};border:1px solid ${T.border};border-radius:${T.radius};padding:7px 11px;color:${T.text};outline:none;transition:border .2s,box-shadow .2s;font-size:13px}
